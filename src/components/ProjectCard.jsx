...
import { FaGithub, FaExternalLinkAlt, FaTags, FaInfoCircle } from "react-icons/fa"
    ...
    <>
      ...
      >
        ...
        <div className="relative h-48 sm:h-56 overflow-hidden">
          <motion.img variants={imageVariants} src={image} alt={title} className="w-full h-full object-cover" />
          ...
          >
            <div className="p-4 w-full">
              <motion.button
                ...
                className="w-full py-2 bg-white/90 text-slate-800 rounded-lg font-medium flex items-center justify-center gap-2 hover:bg-white transition-colors"
              >
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {tags.slice(0, 3).map((tag, tagIndex) => (
              <motion.span
                ...
                animate="animate"
                whileHover="hover"
                className="px-3 py-1 text-xs font-medium bg-slate-100 text-gray-800 rounded-full border border-slate-200"
              >
                {tag}
              </motion.span>
            ))}
            {tags.length > 3 && (
              <motion.span
                ...
                animate="animate"
                whileHover="hover"
                className="px-3 py-1 text-xs font-medium bg-slate-100 text-slate-800 rounded-full border border-slate-200"
              >
                +{tags.length - 3} more
              </motion.span>
            )}
          ...
          <div className="flex space-x-3">
            {githubLink && (
              <motion.a
                ...
                className="flex items-center px-3 py-2 bg-gray-200 text-gray-800 rounded-md hover:bg-gray-300 transition-colors flex-1 justify-center"
              >
            ...
            {demoLink && (
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center px-3 py-2 bg-gray-700 text-white rounded-md hover:bg-slate-800 transition-colors flex-1 justify-center"
              >
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {tags.map((tag, tagIndex) => (
                    <span
                      key={tagIndex}
                      className="px-3 py-1 text-sm font-medium bg-slate-100 text-slate-800 rounded-full border border-slate-200"
                    >
                      {tag}
                    </span>
                  ))}
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                {demoLink && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center px-6 py-3 bg-slate-700 text-white rounded-md hover:bg-slate-800 transition-colors"
                  >
