      ...
      <SectionWrapper id="hero" className="min-h-screen flex items-center">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            >
              <span className="text-3xl sm:text-4xl lg:text56xl text-accent" >Hi, I'm{" "}</span>
              <span className="relative inline-block">
                <span className="relative z-10 text-accent">Zeyad Amr</span>
                <motion.span
                  className="absolute bottom-0 left-0 w-full h-3 bg-accent-light -z-10"
                  initial={{ width: 0 }}
                  animate={{ width: "100%" }}
            ...
            >
              <motion.a
                ...
                className="p-4 glass-effect text-text-primary rounded-full hover:shadow-button  "
                aria-label="GitHub"
              >
            ...
            >
              ...
              >
                <Link
                  to="/projects"
                  className="flex items-center px-8 py-3 bg-accent text-white rounded-lg transition-all"
                >
              ...
              >
                <Link
                  to="/contact"
                  className="px-8 py-3 border border-accent text-accent rounded-lg transition-all"
                >
                  Contact Me
                </Link>
              </motion.div>
...
>
  <div className="relative">
    ...
    <motion.div
      className="absolute -z-10 w-64 h-64 sm:w-80 sm:h-80 rounded-full opacity-20"
      initial={{ x: 20, y: 20 }}
      animate={{ x: 10, y: 10 }}
      transition={{
        repeat: Infinity,
    ...
    <motion.div
      ...
      className="relative w-64 h-64 sm:w-80 sm:h-80 rounded-full overflow-hidden border-4 border-accent shadow-xl"
    >
      <img
        src={img}
        alt="Profile"
    ...
    <motion.div 
  className="absolute -bottom-4 -right-4 w-20 h-20 rounded-full bg-black opacity-60"
  animate={{
    y: [0, -10, 0],
    rotate: [0, 5, 0],
  }}
